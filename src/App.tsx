  ...
  return (
    <Layout>
      <div className="grid grid-cols-5 gap-4">
        <div className="grid grid-cols-5 gap-4 col-span-4 bg-gray-100 p-6 rounded-lg border border-orange-200">
          <div className="p-4 rounded-md">
            <h3 className="text-8xl font-bold text-gray-700">16º</h3>
            <span className="text-gray-700">Feels like 17º</span>
            <h5 className="text-xl text-gray-700">Rain</h5>
            <p className="text-sm text-gray-500">Moderate Rain</p>
          </div>
          <ForcastCard
            temperature={16}
            day="Tuesday"
        ...
        <div className="bg-gray-100 p-6 rounded-lg border border-orange-200 text-center flex flex-col justify-between">
      ...
      <div className="grid grid-cols-5 gap-4 mt-4">
        <WeatherCard image="./vite.svg" title="pressure" value="1015" />
        <WeatherCard image="./vite.svg" title="pressure" value="1015" />
        <WeatherCard image="./vite.svg" title="pressure" value="1015" />
        <WeatherCard image="./vite.svg" title="pressure" value="1015" />
        <WeatherCard image="./vite.svg" title="pressure" value="1015" />
